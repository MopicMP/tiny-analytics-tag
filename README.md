...
[![PyPI version](https://badge.fury.io/py/tiny-analytics-tag.svg)](https://pypi.org/project/tiny-analytics-tag/)
...
```bash
pip install tiny-analytics-tag
```
...
from tiny_analytics_tag import batch
